...
import 'package:maps_google/direction_model.dart';
import 'package:maps_google/direction_repository.dart';
...
class _MapScreenState extends State<MapScreen> {
  static const _initialCameraPosition = CameraPosition(
    target: LatLng(18.5658397, 76.0252693),
    zoom: 11.5,
  );
  ...
  Marker _destination = Marker(
    ...
    position: LatLng(18.5658397, 76.0252693),
  );
  Directions? _info;
